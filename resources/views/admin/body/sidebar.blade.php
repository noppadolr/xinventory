<div class="app-menu">
    ...
    <div class="scrollbar">
        ...
        <div class="user-box text-center">
            <img src="{{ (!empty($adminData->photo))? url('upload/adminImages/'.$adminData->photo):url('upload/no_image.jpg') }}" alt="user-img" title="Mat Helme" class="rounded-circle avatar-md">
            <div class="dropdown">
...
{{--                </div>--}}
                    ...
                    <ul class="sub-menu">
                        <li class="menu-item">
                            <a href="{{ url('supplier/all') }}" class="menu-link">
                                <span class="menu-text">Suppler All</span>
                            </a>
                        </li>
            ...
            <li class="menu-item">
                <a href="#menuCustomer" data-bs-toggle="collapse" class="menu-link">
